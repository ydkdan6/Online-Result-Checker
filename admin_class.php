...
Class Action {
	...
	// Find this method in your admin_class.php file and update it:

function login2(){
    // Check if OTP verification was completed
    if(!isset($_SESSION['verified']) || $_SESSION['verified'] !== true){
        return 0; // Not verified, deny access
    }
    
    extract($_POST);
    $student_code = $_SESSION['student_code']; // Get verified student code from session
    
    // Look up the student (your original code probably does something like this)
    $qry = $this->db->query("SELECT * FROM students WHERE student_code = '$student_code'");
    ...
    if($qry->num_rows > 0){
        ...
        // Clear verification flag for security
